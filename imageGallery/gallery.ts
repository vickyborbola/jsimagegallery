...
class Gallery{
    ...
    mainImageContainer: HTMLElement | null;
    mainImageFrame: HTMLElement | null;
    mainImage: HTMLElement | null;

    constructor(imageArray: Image[]){
    ...
    set changeMainImage(image:Image){
        this.initMainImage(image);        
    }

    set goSlide(direction: string){
